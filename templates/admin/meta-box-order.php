...
<div class="buedoc-meta-box">
    ...
    <?php if (!empty($doc_id)) : ?>
        ...
        <div class="buedoc-field-row">
            <span class="buedoc-label"><?php esc_html_e('Documento Fiscal:', 'buedoc-facturacao-electronica-agt'); ?></span>
        ...
        <div class="buedoc-field-row">
            <span class="buedoc-label"><?php esc_html_e('Data de Emissão:', 'buedoc-facturacao-electronica-agt'); ?></span>
            <span class="buedoc-value"><?php echo esc_html($doc_date); ?></span>
        </div>

        <div class="buedoc-field-row">
            <span class="buedoc-label"><?php esc_html_e('Estado na AGT:', 'buedoc-facturacao-electronica-agt'); ?></span>
            <span class="buedoc-value">
        ...
        <?php if (!empty($doc_hash_short)) : ?>
            <div class="buedoc-field-row">
                <span class="buedoc-label"><?php esc_html_e('Assinatura Fiscal:', 'buedoc-facturacao-electronica-agt'); ?></span>
        ...
        <div class="buedoc-field-row">
            <span class="buedoc-label"><?php esc_html_e('Total Facturado:', 'buedoc-facturacao-electronica-agt'); ?></span>
            <span class="buedoc-value">
        ...
        <?php if (!empty($nc_number)) : ?>
            <div class="buedoc-field-row" style="background:#fef2f2; padding: 6px 8px; border-radius: 4px; margin-top: 6px;">
                <span class="buedoc-label" style="color:#b91c1c;"><?php esc_html_e('Nota de Crédito:', 'buedoc-facturacao-electronica-agt'); ?></span>
                <span class="buedoc-value">
        ...
        <?php if (!empty($doc_qr_code)) : ?>
            <div class="buedoc-qr-box">
                ...
                <div class="buedoc-qr-desc"><?php esc_html_e('QR Code Fiscal certificado pela AGT', 'buedoc-facturacao-electronica-agt'); ?></div>
            </div>
        <?php endif; ?>
    ...
    <?php else : ?>
        ...
        <p style="margin: 0 0 12px 0; color: #64748b;">
            <?php esc_html_e('Nenhum documento fiscal foi gerado para esta encomenda no BueDoc.', 'buedoc-facturacao-electronica-agt'); ?>
        </p>
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 12px; margin-bottom: 12px;">
            <label for="buedoc-manual-doc-type" style="display:block; margin-bottom: 6px; font-weight: 600; font-size: 12px;">
                <?php esc_html_e('Seleccione o tipo de documento a emitir:', 'buedoc-facturacao-electronica-agt'); ?>
            </label>
            <select id="buedoc-manual-doc-type" style="width: 100%; margin-bottom: 10px;">
                <option value="FR"><?php esc_html_e('Factura-Recibo (FR) — Venda paga', 'buedoc-facturacao-electronica-agt'); ?></option>
